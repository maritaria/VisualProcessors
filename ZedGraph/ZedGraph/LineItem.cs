...
namespace ZedGraph
{
	...
	public class LineItem : CurveItem, ICloneable, ISerializable
	{
		...
		/// <summary>
		///  Private field that stores a reference to the <see cref="ZedGraph.Line" /> class defined
		///  for this <see cref="LineItem" />. Use the public property <see cref="Line" /> to access
		///  this value.
		/// </summary>
		protected Line _line;

		/// <summary>
		///  Private field that stores a reference to the <see cref="ZedGraph.Symbol" /> class
		///  defined for this <see cref="LineItem" />. Use the public property <see cref="Symbol" />
		...
		/// <summary>
		///  Gets or sets the <see cref="ZedGraph.Line" /> class instance defined for this <see
		///  cref="LineItem" />.
		/// </summary>
		public Line Line
		{
		...
		/// <summary>
		///  Gets or sets the <see cref="ZedGraph.Symbol" /> class instance defined for this <see
		///  cref="LineItem" />.
		/// </summary>
		...
		/// <summary>
		///  Create a new <see cref="LineItem" />, specifying only the legend <see
		///  cref="CurveItem.Label" />.
		/// </summary>
		...
		/// </param>
		/// <param name="color">     
		///  A <see cref="Color" /> value that will be applied to the <see cref="Line" /> and <see
		///  cref="Symbol" /> properties.
		/// </param>
		/// <param name="symbolType">
		///  A <see cref="SymbolType" /> enum specifying the type of symbol to use for this <see
		///  cref="LineItem" />. Use <see cref="SymbolType.None" /> to hide the symbols.
		/// </param>
		/// <param name="lineWidth"> 
		///  The width (in points) to be used for the <see cref="Line" />. This width is scaled
		///  based on <see cref="PaneBase.CalcScaleFactor" />. Use a value of zero to hide the line
		///  (see <see cref="ZedGraph.LineBase.IsVisible" />).
		/// </param>
		...
		/// <summary>
		///  Do all rendering associated with this <see cref="LineItem" /> to the specified <see
		...
		/// <summary>
		///  Loads some pseudo unique colors/symbols into this LineItem. This is mainly useful for
		///  differentiating a set of new LineItems without having to pick your own colors/symbols.
		///  <seealso cref="CurveItem.MakeUnique( ColorSymbolRotator )" />
		/// </summary>
		/// <param name="rotator">
		///  The <see cref="ColorSymbolRotator" /> that is used to pick the color and symbol for
		///  this method call.
		/// </param>
