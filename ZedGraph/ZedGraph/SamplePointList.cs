...
namespace ZedGraph
{
	...
	public class SamplePointList : IPointList
	{
		...
		/// <returns>
		///  Returns a <see cref="PointPair" /> instance containing the data specified by <see
		///  cref="XType" /> and <see cref="YType" />
		/// </returns>
		...
		/// </summary>
		/// <returns>
		///  A new cloned SamplePointList. This returns a copy of the structure, but it does not
