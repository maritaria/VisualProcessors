...
namespace ZedGraph
{
	...
	public class XAxis : Axis, ICloneable, ISerializable
	{
		...
		/// <summary>
		///  A simple struct that defines the default property values for the <see cref="XAxis" />
		///  class.
		/// </summary>
		public new struct Default
		{
			...
			/// <summary>
			///  Determines if a line will be drawn at the zero value for the <see cref="XAxis" />,
		...
		/// <summary>
		///  Default constructor that sets all <see cref="XAxis" /> properties to default values as
		...
		{
			// Move the origin to the BottomLeft of the ChartRect, which is the left side of the X
