...
namespace ZedGraph
{
	...
	public class X2Axis : Axis, ICloneable, ISerializable
	{
		...
		/// <summary>
		///  A simple struct that defines the default property values for the <see cref="X2Axis" />
		///  class.
		/// </summary>
		public new struct Default
		{
			// <summary>
			//  The default display mode for the <see cref="X2Axis" /> (<see cref="Axis.IsVisible"
			...
			/// <summary>
			///  Determines if a line will be drawn at the zero value for the <see cref="X2Axis" />,
		...
		/// <summary>
		///  Default constructor that sets all <see cref="X2Axis" /> properties to default values as
		...
		{
			// Move the origin to the TopLeft of the ChartRect, which is the left side of the X2
		...
		/// </summary>
		/// <remarks>
		///  The primary axes are the <see cref="XAxis" /> (always), the <see cref="X2Axis" />
		///  (always), the first <see cref="YAxis" /> in the <see cref="GraphPane.YAxisList" />
		///  (<see cref="CurveItem.YAxisIndex" /> = 0), and the first <see cref="Y2Axis" /> in the
		///  <see cref="GraphPane.Y2AxisList" /> (<see cref="CurveItem.YAxisIndex" /> = 0). Note
		///  that <see cref="GraphPane.YAxis" /> and <see cref="GraphPane.Y2Axis" /> always
		///  reference the primary axes.
		/// </remarks>
		/// <param name="pane">
		///  A reference to the <see cref="GraphPane" /> object that is the parent or owner of this
		///  object.
		...
		*/
		...
		// override internal float GetMinPix( GraphPane pane ) { return pane.Chart._rect.Left; }
