...
namespace ZedGraph
{
	...
	public class LineObj : GraphObj, ICloneable, ISerializable
	{
		...
		/// <summary>
		///  protected field that maintains the attributes of the line using an instance of the <see
		///  cref="LineBase" /> class.
		/// </summary>
		...
		/// <summary>
		///  A <see cref="LineBase" /> class that contains the attributes for drawing this <see
		///  cref="LineObj" />.
		/// </summary>
		...
		/// </param>
		/// <param name="x1">   
		///  The x position of the starting point that defines the line. The units of this position
		///  are specified by the <see cref="Location.CoordinateFrame" /> property.
		/// </param>
		/// <param name="y1">   
		///  The y position of the starting point that defines the line. The units of this position
		///  are specified by the <see cref="Location.CoordinateFrame" /> property.
		/// </param>
		/// <param name="x2">   
		///  The x position of the ending point that defines the line. The units of this position
		///  are specified by the <see cref="Location.CoordinateFrame" /> property.
		/// </param>
		/// <param name="y2">   
		///  The y position of the ending point that defines the line. The units of this position
		///  are specified by the <see cref="Location.CoordinateFrame" /> property.
		/// </param>
		...
		/// <summary>
		///  A constructor that allows only the position of the line to be pre-specified. All other
		///  properties are set to default values
		/// </summary>
		/// <param name="x1">
		///  The x position of the starting point that defines the <see cref="LineObj" />. The units
		///  of this position are specified by the <see cref="Location.CoordinateFrame" /> property.
		/// </param>
		/// <param name="y1">
		///  The y position of the starting point that defines the <see cref="LineObj" />. The units
		///  of this position are specified by the <see cref="Location.CoordinateFrame" /> property.
		/// </param>
		/// <param name="x2">
		///  The x position of the ending point that defines the <see cref="LineObj" />. The units
		///  of this position are specified by the <see cref="Location.CoordinateFrame" /> property.
		/// </param>
		/// <param name="y2">
		///  The y position of the ending point that defines the <see cref="LineObj" />. The units
		///  of this position are specified by the <see cref="Location.CoordinateFrame" /> property.
		/// </param>
		...
		/// <summary>
		///  Default constructor -- places the <see cref="LineObj" /> at location (0,0) to (1,1).
		...
		override public void Draw(Graphics g, PaneBase pane, float scaleFactor)
		{
				...
				pix2.X > -10000 && pix2.X < 100000 && pix2.Y > -100000 && pix2.Y < 100000)
			{
				...
				// Move the coordinate system so it is located at the starting point of this arrow
				g.TranslateTransform(pix1.X, pix1.Y);

				// Rotate the coordinate system according to the angle of this arrow about the
				// starting point
