...
namespace ZedGraph
{
	partial class ZedGraphControl
	{
		...
		/// <summary>
		///  Gets or sets the <see cref="System.Drawing.Printing.PrintDocument" /> instance that is
		///  used for all of the context menu printing functions.
		/// </summary>
		...
		/// <summary>
		///  Display a <see cref="PageSetupDialog" /> to the user, allowing them to modify the print
		///  settings for this <see cref="ZedGraphControl" />.
		/// </summary>
		...
		/// <summary>
		///  Display a <see cref="PrintDialog" /> to the user, allowing them to select a printer and
		///  print the <see cref="MasterPane" /> contained in this <see cref="ZedGraphControl" />.
		/// </summary>
		public void DoPrint()
		{
			// Add a try/catch pair since the users of the control can't catch this one
		...
		///  subsequently print the <see cref="MasterPane" /> contained in this <see
		///  cref="ZedGraphControl" />.
		/// </summary>
		...
		/// <summary>
		///  Handler for the "Page Setup..." context menu item. Displays a <see
		///  cref="PageSetupDialog" />.
		/// </summary>
		...
		/// <summary>
		///  Handler for the "Print..." context menu item. Displays a <see cref="PrintDialog" />.
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e">     </param>
		...
		/// <param name="e">     
		///  A <see cref="PrintPageEventArgs" /> instance providing page bounds, margins, and a
		///  Graphics instance for this printed output.
		/// </param>
