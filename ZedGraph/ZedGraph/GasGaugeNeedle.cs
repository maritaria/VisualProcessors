...
{
	/// <summary>
	///  A class representing a needle on the GasGuage chart <see cref="GasGaugeNeedle" />s.
	/// </summary>
	...
	public class GasGaugeNeedle : CurveItem, ICloneable, ISerializable
	{
		...
		///  of the border around this <see cref="GasGaugeNeedle" />. Use the public property <see
		...
		///  cref="GasGaugeNeedle" />. Use the public property <see cref="Fill" /> to access this
		///  value.
		/// </summary>
		private Fill _fill;
		...
		/// <summary>
		///  Private field to hold the GraphicsPath of this <see cref="GasGaugeNeedle" /> to be used
		///  for 'hit testing'.
		/// </summary>
		...
		/// </summary>
		/// <param name="label">
		///  The value associated with this <see cref="GasGaugeNeedle" /> instance.
		/// </param>
		/// <param name="color">
		///  The display color for this <see cref="GasGaugeNeedle" /> instance.
		/// </param>
		...
		{
			/// <summary>
			///  The default color for drawing frames around GasGaugeNeedle (<see
			...
			/// <summary>
			///  The default custom brush for filling in the GasGaugeNeedle. (<see
			///  cref="ZedGraph.Fill.Brush" /> property).
			/// </summary>
			public static Brush FillBrush = null;

			/// <summary>
			///  The default color for filling in the GasGaugeNeedle (<see
			...
			/// <summary>
			///  The default font size for <see cref="GasGaugeNeedle.LabelDetail" /> entries (<see
			...
			/// <summary>
			///  The default width of the gas gauge needle. Units are points, scaled according to
			///  <see cref="PaneBase.CalcScaleFactor" />
			/// </summary>
		...
		///  rectangle of the GasGaugeNeedle.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		///  Do all rendering associated with this <see cref="GasGaugeNeedle" /> item to the
		///  specified <see cref="Graphics" /> device. This method is normally only called by the
		///  Draw method of the parent <see cref="ZedGraph.CurveList" /> collection object.
		/// </summary>
		/// <param name="g">          
		///  A graphic device object to be drawn into. This is normally e.Graphics from the
		///  PaintEventArgs argument to the Paint() method.
