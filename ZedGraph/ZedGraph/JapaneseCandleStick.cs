...
namespace ZedGraph
{
	...
	public class JapaneseCandleStick : OHLCBar, ICloneable, ISerializable
	{
		...
		///  value is less than the <see cref="StockPt.Open" /> value. Use the public property <see
		///  cref="FallingColor" /> to access this value.
		/// </summary>
		protected Color _fallingColor;

		/// <summary>
		///  Private field to store the <see cref="Border" /> class to be used for drawing the
		///  candlestick "bars" when the <see cref="StockPt.Close" /> value is less than the <see
		///  cref="StockPt.Open" /> value. See the public property <see cref="FallingBorder" /> to
		///  access this value.
		/// </summary>
		...
		///  candlestick "bars" when the <see cref="StockPt.Close" /> value is less than the <see
		///  cref="StockPt.Open" /> value. See the public property <see cref="FallingFill" /> to
		///  access this value.
		/// </summary>
		...
		/// <summary>
		///  Private field to store the <see cref="Border" /> class to be used for drawing the
		///  candlestick "bars" when the <see cref="StockPt.Close" /> value is greater than the <see
		///  cref="StockPt.Open" /> value. See the public property <see cref="RisingBorder" /> to
		///  access this value.
		/// </summary>
		...
		///  Private field to store the <see cref="Fill" /> class to be used for filling the
		///  candlestick "bars" when the <see cref="StockPt.Close" /> value is greater than the <see
		///  cref="StockPt.Open" /> value. See the public property <see cref="RisingFill" /> to
		///  access this value.
		/// </summary>
		...
		/// <summary>
		///  A simple struct that defines the default property values for the <see
		///  cref="ZedGraph.JapaneseCandleStick" /> class.
		/// </summary>
		public new struct Default
		{
			/// <summary>
			///  The default color for the border of the falling CandleSticks (<see
			///  cref="JapaneseCandleStick.FallingBorder" /> property).
			/// </summary>
			public static Color FallingBorder = Color.Black;

			/// <summary>
			///  The default fillcolor for drawing the falling case CandleSticks (<see
			///  cref="JapaneseCandleStick.FallingFill" /> property).
			/// </summary>
			public static Color FallingColor = Color.Black;

			/// <summary>
			///  The default color for the border of the rising CandleSticks (<see
			///  cref="JapaneseCandleStick.RisingBorder" /> property).
			/// </summary>
			public static Color RisingBorder = Color.Black;

			/// <summary>
			///  The default fillcolor for drawing the rising case CandleSticks (<see
			///  cref="JapaneseCandleStick.RisingFill" /> property).
			/// </summary>
		...
		/// <summary>
		///  The <see cref="Border" /> instance to be used for drawing the border frame of the
		///  candlestick "bars" when the <see cref="StockPt.Close" /> value is less than the <see
		///  cref="StockPt.Open" /> value.
		/// </summary>
		...
		/// <summary>
		///  Gets or sets the <see cref="System.Drawing.Color" /> data for this <see
		///  cref="JapaneseCandleStick" /> when the value of the candlestick is falling.
		/// </summary>
		/// <remarks>
		///  This property only controls the color of the vertical line when the value is falling.
		///  The rising color is controlled by the <see cref="LineBase.Color" /> property.
		/// </remarks>
		...
		/// <summary>
		///  Gets or sets the <see cref="Fill" /> class that is used to fill the candlestick "bars"
		///  when the <see cref="StockPt.Close" /> value is less than the <see cref="StockPt.Open"
		///  /> value.
		/// </summary>
		...
		/// <summary>
		///  Gets or sets the <see cref="Fill" /> class that is used to fill the candlestick "bars"
		///  when the <see cref="StockPt.Close" /> value is greater than the <see
		///  cref="StockPt.Open" /> value.
		/// </summary>
		...
		/// </param>
		/// <param name="pane">       
		///  A reference to the <see cref="GraphPane" /> object that is the parent or owner of this
		///  object.
		/// </param>
		/// <param name="isXBase">    
		///  boolean value that indicates if the "base" axis for this <see
		///  cref="JapaneseCandleStick" /> is the X axis. True for an <see cref="XAxis" /> base,
		...
		///  The scaling factor for the features of the graph based on the <see
		///  cref="PaneBase.BaseDimension" />. This scaling factor is calculated by the <see
		///  cref="PaneBase.CalcScaleFactor" /> method. The scale factor represents a linear
		///  multiple to be applied to font sizes, symbol sizes, etc.
		/// </param>
		/// <param name="pen">        
		///  A pen with the <see cref="Color" /> attribute for this <see cref="JapaneseCandleStick"
		///  />
		/// </param>
		/// <param name="fill">       
		///  The <see cref="Fill" /> instance to be used for filling this <see
		///  cref="JapaneseCandleStick" />
		/// </param>
		/// <param name="border">     
		///  The <see cref="Border" /> instance to be used for drawing the border around the <see
		///  cref="JapaneseCandleStick" /> filled box
		/// </param>
		/// <param name="pt">         
		///  The <see cref="PointPair" /> to be used for determining the <see cref="Fill" />, just
		///  in case it's a <see cref="FillType.GradientByX" />, <see cref="FillType.GradientByY"
		///  />, or <see cref="FillType.GradientByZ" /><see cref="FillType" />
		/// </param>
		...
		/// </param>
		/// <param name="curve">      
		///  A <see cref="JapaneseCandleStickItem" /> object representing the <see
		///  cref="JapaneseCandleStick" />'s to be drawn.
		/// </param>
		/// <param name="baseAxis">   
		///  The <see cref="Axis" /> class instance that defines the base (independent) axis for the
		///  <see cref="JapaneseCandleStick" />
		/// </param>
		/// <param name="valueAxis">  
		///  The <see cref="Axis" /> class instance that defines the value (dependent) axis for the
		///  <see cref="JapaneseCandleStick" />
		/// </param>
		/// <param name="scaleFactor">
		///  The scaling factor to be used for rendering objects. This is calculated and passed down
		///  by the parent <see cref="GraphPane" /> object using the <see
			...
			if (curve.Points != null)
			{
				...
				using (Pen fallingPen = new Pen(tFallingColor, tPenWidth))
				{
					...
					for (int i = 0; i < curve.Points.Count; i++)
					{
						...
						// Any value set to double max is invalid and should be skipped This is used
						// for calculated values that are out of range, divide by zero, etc. Also,
						// any value <= zero on a log scale is invalid
