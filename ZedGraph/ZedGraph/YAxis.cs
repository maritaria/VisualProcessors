...
namespace ZedGraph
{
	...
	public class YAxis : Axis, ICloneable, ISerializable
	{
		...
		/// <summary>
		///  A simple struct that defines the default property values for the <see cref="YAxis" />
		///  class.
		/// </summary>
		public new struct Default
		{
			...
			/// <summary>
			///  Determines if a line will be drawn at the zero value for the <see cref="YAxis" />,
		...
		/// <summary>
		///  Default constructor that sets all <see cref="YAxis" /> properties to default values as
		...
		{
			// Move the origin to the TopLeft of the ChartRect, which is the left side of the axis
			// (facing from the label side)
