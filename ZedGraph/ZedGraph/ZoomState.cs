...
namespace ZedGraph
{
	...
	/// </summary>
	/// <remarks>
	///  This class is used to store scale ranges in order to allow zooming out to prior scale range
	///  states. <see cref="ZoomState" /> objects are maintained in the <see cref="ZoomStateStack"
	///  /> collection. The <see cref="ZoomState" /> object holds a <see cref="ScaleState" /> object
	///  for each of the three axes; the <see cref="XAxis" />, the <see cref="YAxis" />, and the
	///  <see cref="Y2Axis" />.
	/// </remarks>
	...
	{
		/// <summary>
		///  An enum value indicating the type of adjustment being made to the scale range state.
		/// </summary>
		...
		/// <summary>
		///  Construct a <see cref="ZoomState" /> object from the scale ranges settings contained in
		///  the specified <see cref="GraphPane" />.
		/// </summary>
		/// <param name="pane">
		///  The <see cref="GraphPane" /> from which to obtain the scale range values.
		/// </param>
		/// <param name="type">
		///  A <see cref="StateType" /> enumeration that indicates whether this saved state is from
		///  a pan or zoom.
		/// </param>
		...
		/// <summary>
		///  Gets a <see cref="StateType" /> value indicating the type of action (zoom or pan) saved
		///  by this <see cref="ZoomState" />.
		/// </summary>
		...
		/// <summary>
		///  Gets a string representing the type of adjustment that was made when this scale state
		///  was saved.
		/// </summary>
		/// <value>
		///  A string representation for the state change type; typically "Pan", "Zoom", or
		///  "Scroll".
		/// </value>
		...
		/// <summary>
		///  Copy the properties from this <see cref="ZoomState" /> out to the specified <see
		///  cref="GraphPane" />.
		/// </summary>
		/// <param name="pane">
		...
		/// <summary>
		///  Determine if the state contained in this <see cref="ZoomState" /> object is different
		///  from the state of the specified <see cref="GraphPane" />.
		/// </summary>
		/// <param name="pane">
