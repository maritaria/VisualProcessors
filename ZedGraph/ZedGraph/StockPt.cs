...
namespace ZedGraph
{
	...
	public class StockPt : PointPair, ISerializable
	{
		...
		// member variable mapping: Date = X High = Y Low = Z Open = Open Close = Close Vol = Vol
		...
		/// <summary>
		///  This is a user value that can be anything. It is used to provide special property-based
		///  coloration to the graph elements.
		/// </summary>
		...
		/// <summary>
		///  The ColorValue property. This is used with the <see
		...
		/// <summary>
		///  Readonly value that determines if either the Date, Close, Open, High, or Low coordinate
		///  in this StockPt is an invalid (not plotable) value. It is considered invalid if it is
		///  missing (equal to System.Double.Max), Infinity, or NaN.
		/// </summary>
		...
		/// <summary>
		///  Format this StockPt value using the default format. Example: "( 12.345, -16.876 )". The
		///  two double values are formatted with the "g" format type.
		/// </summary>
		...
		///  If <see paramref="isShowAll" /> is true, then the third all coordinates are shown.
		/// </summary>
		/// <param name="format">   
