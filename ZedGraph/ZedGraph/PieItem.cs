...
{
	/// <summary>
	///  A class representing a pie chart object comprised of one or more <see cref="PieItem" />s.
	/// </summary>
	...
	public class PieItem : CurveItem, ICloneable, ISerializable
	{
		...
		/// <summary>
		///  Private field instance of the <see cref="PieItem" /> class indicating whetherthe
		///  instance is displayed in 2D or 3D.(see <see cref="PieItem.PieType" />)
		/// </summary>
...
*/
		...
		/// <summary>
		///  Private field that stores the <see cref="Border" /> class that defines the properties
		///  of the border around this <see cref="PieItem" />. Use the public property <see
		///  cref="Border" /> to access this value.
		/// </summary>
		...
		/// <summary>
		///  Percentage (expressed as #.##) of <see cref="PieItem" /> radius to which this <see
		///  cref="PieItem" /> is to be displaced from the center. Displacement is done outward
		///  along the radius bisecting the chord of this <see cref="PieItem" />. Maximum allowable
		///  value is 0.5.
		/// </summary>
		private double _displacement;

		/// <summary>
		///  The point at the end of the line between this <see cref="PieItem" /> and it's label
		///  (i.e. the beginning of the label display)
		/// </summary>
		private PointF _endPoint;

		/// <summary>
		///  Private field that stores the <see cref="ZedGraph.Fill" /> data for this <see
		///  cref="PieItem" />. Use the public property <see cref="Fill" /> to access this value.
		/// </summary>
		private Fill _fill;
		...
		/// <summary>
		///  A <see cref="ZedGraph.TextObj" /> which will customize the label display of this <see
		///  cref="PieItem" />
		/// </summary>
		private TextObj _labelDetail;

		/// <summary>
		///  The formatted string for this <see cref="PieItem" />'s label. Formatting is done based
		///  on the <see cref="PieLabelType" />.
		/// </summary>
		private string _labelStr;

		/// <summary>
		///  An enum that specifies how each <see cref="CurveItem.Label" /> for this <see
		///  cref="PieItem" /> object will be displayed. Use the public property <see
		///  cref="LabelType" /> to access this data. Use enum <see cref="ZedGraph.PieLabelType" />.
		/// </summary>
		...
		/// <summary>
		///  The point at which the line between this <see cref="PieItem" /> and its label bends to
		///  the horizontal.
		/// </summary>
		private PointF _pivotPoint;

		/// <summary>
		///  Private field to hold the GraphicsPath of this <see cref="PieItem" /> to be used for
		///  'hit testing'.
		/// </summary>
		private GraphicsPath _slicePath;

		/// <summary>
		///  Private field which holds the angle (in degrees) at which the display of this <see
		///  cref="PieItem" /> object will begin.
		/// </summary>
		...
		{
			/// <summary>
			///  The default color for drawing frames around PieItem (<see
			///  cref="ZedGraph.LineBase.Color" /> property).
			/// </summary>
			public static Color BorderColor = Color.Black;

			/// <summary>
			///  The default pen width to be used for drawing the border around the PieItem (<see
			///  cref="ZedGraph.LineBase.Width" /> property). Units are points.
			/// </summary>
			...
			/// <summary>
			///  The default custom brush for filling in the PieItem. (<see
			///  cref="ZedGraph.Fill.Brush" /> property).
			/// </summary>
			...
			/// <summary>
			///  The default font size for <see cref="PieItem.LabelDetail" /> entries (<see
			///  cref="ZedGraph.FontSpec.Size" /> property). Units are in points (1/72 inch).
			/// </summary>
			...
			/// <summary>
			///  Default value for the number of decimal digits to be displayed where <see
			///  cref="LabelType" /> contains a percent.
			/// </summary>
			public static int PercentDecimalDigits = 2;

			/// <summary>
			///  Default value for the number of decimal digits to be displayed when <see
			///  cref="LabelType" /> contains a value.
			/// </summary>
		...
		/// <summary>
		///  Gets or sets the <see cref="Border" /> object so as to be able to modify its
		///  properties.
		/// </summary>
		...
		/// <summary>
		///  Gets or sets the a value which determines the amount, if any, of this <see
		///  cref="PieItem" /> displacement.
		/// </summary>
		...
		/// <summary>
		///  Gets or sets the <see cref="Fill" /> object which is used to fill the pie slice with
		///  color.
		/// </summary>
		public Fill Fill
		{
		...
		/// <summary>
		///  Gets or sets the <see cref="TextObj" /> to be used for displaying this <see
		///  cref="PieItem" />'s label.
		/// </summary>
		...
		/// <summary>
		///  Gets or sets the <see cref="PieLabelType" /> to be used in displaying <see
		///  cref="PieItem" /> labels.
		/// </summary>
		...
		/// <summary>
		///  Gets or sets the value of this <see cref="PieItem" />. Minimum value is 0.
		/// </summary>
		public double Value
		{
		...
		/// <summary>
		///  Gets or sets the angle (in degrees) of the radius along which this <see cref="PieItem"
		///  /> will be displaced.
		/// </summary>
 ...
 */
		...
		/// <summary>
		///  Gets a flag indicating if the X axis is the independent axis for this <see
		///  cref="CurveItem" />
		/// </summary>
		/// <param name="pane">
		...
		/// <summary>
		///  Gets a flag indicating if the Z data range should be included in the axis scaling
		///  calculations.
		/// </summary>
		/// <param name="pane">
		///  The parent <see cref="GraphPane" /> of this <see cref="CurveItem" />.
		...
		/// </param>
		/// <param name="color1">      
		///  The starting display color for the gradient <see cref="Fill" /> for this <see
		///  cref="PieItem" /> instance.
		/// </param>
		/// <param name="color2">      
		///  The ending display color for the gradient <see cref="Fill" /> for this <see
		///  cref="PieItem" /> instance.
		/// </param>
		/// <param name="fillAngle">   The angle for the gradient <see cref="Fill" />.</param>
		/// <param name="displacement">
		///  The amount this <see cref="PieItem" /> instance will be displaced from the center
		///  point.
		/// </param>
		...
		/// <summary>
		///  Calculate the <see cref="RectangleF" /> that will be used to define the bounding
		///  rectangle of the Pie.
		/// </summary>
		/// <remarks>
		///  This rectangle always lies inside of the <see cref="Chart.Rect" />, and it is normally
		///  a square so that the pie itself is not oval-shaped.
		/// </remarks>
		/// <param name="g">          
		...
		/// </param>
		/// <param name="pane">       
		///  A reference to the <see cref="ZedGraph.GraphPane" /> object that is the parent or owner
		///  of this object.
		/// </param>
		/// <param name="scaleFactor">
		///  The scaling factor to be used for rendering objects. This is calculated and passed down
		///  by the parent <see cref="ZedGraph.GraphPane" /> object using the <see
		///  cref="PaneBase.CalcScaleFactor" /> method, and is used to proportionally adjust font
		///  sizes, etc. according to the actual size of the graph.
		/// </param>
		/// <param name="chartRect">  
		///  The <see cref="RectangleF" /> (normally the <see cref="Chart.Rect" />) that bounds this
		///  pie.
		/// </param>
		/// <returns></returns>
		...
		/// <summary>
		///  This method collects all the data relative to rendering this <see cref="PieItem" />'s
		///  label.
		/// </summary>
		/// <param name="g">          
		///  A graphic device object to be drawn into. This is normally e.Graphics from the
		...
		/// <summary>
		///  Do all rendering associated with this <see cref="PieItem" /> item to the specified <see
		///  cref="Graphics" /> device. This method is normally only called by the Draw method of
		///  the parent <see cref="ZedGraph.CurveList" /> collection object.
		/// </summary>
		/// <param name="g">          
		///  A graphic device object to be drawn into. This is normally e.Graphics from the
		///  PaintEventArgs argument to the Paint() method.
		...
		///  of this object.
		/// </param>
		/// <param name="pos">        Not used for rendering Pies</param>
		/// <param name="scaleFactor">
		///  The scaling factor to be used for rendering objects. This is calculated and passed down
		///  by the parent <see cref="ZedGraph.GraphPane" /> object using the <see
		///  cref="PaneBase.CalcScaleFactor" /> method, and is used to proportionally adjust font
		...
		/// <summary>
		///  Determine the coords for the rectangle associated with a specified point for this <see
		///  cref="CurveItem" />
		/// </summary>
		/// <param name="pane">  The <see cref="GraphPane" /> to which this curve belongs</param>
		/// <param name="i">     The index of the point of interest</param>
		/// <param name="coords">
		///  A list of coordinates that represents the "rect" for this point (used in an html AREA
		///  tag)
		/// </param>
		...
		override public bool GetCoords(GraphPane pane, int i, out string coords)
		{
			...
			// Move the coordinate system to local coordinates of this text object (that is, at the
		...
		/// <summary>
		///  Build the string that will be displayed as the slice label as determined by <see
		///  cref="LabelType" />.
		/// </summary>
		...
		///  <see cref="PieItem" />'s in the pie chart. This method is called after it is found that
		///  at least one slice is displaced.
		/// </summary>
