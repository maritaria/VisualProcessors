...
{
	/// <summary>
	///  Encapsulates a CandleStick curve type that displays a vertical (or horizontal) line
	///  displaying the range of data values at each sample point, plus an starting mark and an
	///  ending mark signifying the opening and closing value for the sample.
	/// </summary>
	/// <remarks>
	...
	///  cref="StockPt.High" />, and <see cref="StockPt.Low" /> members. For a vertical CandleStick
	///  chart, the opening value is drawn as a horizontal line segment to the left of the vertical
	///  range bar, and the closing value is a horizontal line segment to the right. The total
	///  length of these two line segments is controlled by the <see cref="ZedGraph.OHLCBar.Size" />
	///  property, which is specified in points (1/72nd inch), and scaled according to <see
	///  cref="PaneBase.CalcScaleFactor" />. The candlesticks are drawn horizontally or vertically
	///  depending on the value of <see cref="BarSettings.Base" />, which is a <see
	///  cref="ZedGraph.BarBase" /> enum type.
	/// </remarks>
	...
	public class OHLCBarItem : CurveItem, ICloneable, ISerializable
	{
		...
		/// <summary>
		///  Gets a reference to the <see cref="OHLCBar" /> class defined for this <see
		///  cref="OHLCBarItem" />.
		/// </summary>
		public OHLCBar Bar
		{
		...
		/// </summary>
		/// <remarks>
		///  IsZIncluded is true for <see cref="OHLCBarItem" /> objects, since the Y and Z values
		///  are defined as the High and Low values for the day.
		/// </remarks>
		/// <param name="pane">
		///  The parent <see cref="GraphPane" /> of this <see cref="CurveItem" />.
		/// </param>
