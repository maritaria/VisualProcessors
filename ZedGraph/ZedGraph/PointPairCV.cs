...
{
	/// <summary>
	///  A simple instance that stores a data point (X, Y, Z). This differs from a regular <see
	///  cref="PointPair" /> in that it maps the <see cref="ColorValue" /> property to an
	///  independent value. That is, <see cref="ColorValue" /> and <see cref="PointPair.Z" /> are
	///  not related (as they are in the <see cref="PointPair" />).
	/// </summary>
