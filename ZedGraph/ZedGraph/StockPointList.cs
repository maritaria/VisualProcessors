...
namespace ZedGraph
{
	...
	public class StockPointList : List<StockPt>, IPointList, IPointListEdit
	{
		...
		/// <summary>
		///  Indexer to access the specified <see cref="StockPt" /> object by its ordinal position
		///  in the list.
		/// </summary>
		/// <param name="index">
		///  The ordinal position (zero-based) of the <see cref="StockPt" /> object to be accessed.
		/// </param>
		...
		/// </summary>
		/// <param name="point">The <see cref="StockPt" /> object to be added</param>
		...
		{
			// throw new ArgumentException( "Error: Only the StockPt type can be added to
			// StockPointList" + ". An ordinary PointPair is not allowed" );
			base.Add(new StockPt(point));
		}

		/// <summary>
		///  Add a <see cref="StockPt" /> object to the collection at the end of the list using the
		///  specified values. The unspecified values (low, open, close) are all set to <see
		///  cref="PointPairBase.Missing" />.
		/// </summary>
		...
		/// </summary>
		/// <remarks>
		///  To be compatible with the <see cref="IPointList" /> interface, the <see
		///  cref="StockPointList" /> must implement an index that returns a <see cref="PointPair"
		///  /> rather than a <see cref="StockPt" />. This method will return the actual <see
		///  cref="StockPt" /> at the specified position.
		/// </remarks>
		/// <param name="index">The ordinal position (zero-based) in the list</param>
		/// <returns>The specified <see cref="StockPt" />.</returns>
