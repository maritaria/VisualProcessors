...
namespace ZedGraph
{
	...
	{
		// <summary>
		//  Subscribe to this event to receive notice that the list of selected CurveItems has
		//  changed
		// </summary>
		...
		/// <summary>
		///  The <see cref="Border" /> type to be used for drawing "selected" <see cref="PieItem"
		///  />, <see cref="BarItem" />, <see cref="HiLowBarItem" />, <see cref="OHLCBarItem" />,
		///  and <see cref="JapaneseCandleStickItem" /> item types.
		/// </summary>
		public static Border Border = new Border(Color.Gray, 1.0f);

		/// <summary>
		///  The <see cref="Fill" /> type to be used for drawing "selected" <see cref="PieItem" />,
		///  <see cref="BarItem" />, <see cref="HiLowBarItem" />, and <see
		///  cref="JapaneseCandleStickItem" /> item types.
		/// </summary>
		public static Fill Fill = new Fill(Color.Gray);

		/// <summary>
		///  The <see cref="Line" /> type to be used for drawing "selected" <see cref="LineItem" />
		///  and <see cref="StickItem" /> types
		/// </summary>
		public static Line Line = new Line(Color.Gray);

		// <summary>
		//  The <see cref="Symbol" /> type to be used for drawing "selected" <see cref="LineItem" />
		//  and <see cref="ErrorBarItem" /> types.
		// </summary>
		...
		/// <summary>
		///  Mark the <see cref="CurveItem" />'s that are included in the selection list by setting
		///  the <see cref="CurveItem.IsSelected" /> property to true.
		/// </summary>
		/// <param name="master">
		///  The <see cref="MasterPane" /> that "owns" the selection list.
		/// </param>
