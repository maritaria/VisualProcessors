...
namespace ZedGraph
{
	...
	public class ZoomStateStack : List<ZoomState>, ICloneable
	{
		...
		/// </summary>
		/// <value>
		///  A <see cref="ZoomState" /> object reference, or null if the stack is empty.
		/// </value>
		...
		/// <summary>
		///  Pop a <see cref="ZoomState" /> entry from the top of the stack, and apply the
		///  properties to the specified <see cref="GraphPane" /> object.
		/// </summary>
		/// <param name="pane">
		///  The <see cref="GraphPane" /> object to which the scale range information should be
		///  copied.
		/// </param>
		/// <returns>
		///  The <see cref="ZoomState" /> object that was "popped" from the stack and applied to the
		///  specified <see cref="GraphPane" />. null if no <see cref="ZoomState" /> was available
		///  (the stack was empty).
		/// </returns>
		...
		/// <summary>
		///  Pop the <see cref="ZoomState" /> entry from the bottom of the stack, and apply the
		///  properties to the specified <see cref="GraphPane" /> object. Clear the stack
		///  completely.
		/// </summary>
		/// <param name="pane">
		///  The <see cref="GraphPane" /> object to which the scale range information should be
		...
		/// </param>
		/// <returns>
		///  The <see cref="ZoomState" /> object at the bottom of the stack that was applied to the
		///  specified <see cref="GraphPane" />. null if no <see cref="ZoomState" /> was available
		///  (the stack was empty).
		/// </returns>
		...
		/// </summary>
		/// <param name="pane">
		///  The <see cref="GraphPane" /> object from which the scale range information should be
		///  copied.
		/// </param>
		/// <param name="type">
		///  A <see cref="ZoomState.StateType" /> enumeration that indicates whether this state is
		///  the result of a zoom or pan operation.
		/// </param>
		/// <returns>
		...
		/// </param>
		/// <returns>
		///  The <see cref="ZoomState" /> object (same as the <see paramref="state" />
		///  parameter) .
		/// </returns>
