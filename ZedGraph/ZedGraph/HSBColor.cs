...
{
	/// <summary>
	///  Hue-Saturation-Brightness Color class to store a color value, and to manage conversions to
	///  and from RGB colors in the <see cref="Color" /> struct.
	/// </summary>
	/// <remarks>
	///  This class is based on code from http://www.cs.rit.edu/~ncs/color/ by Eugene Vishnevsky.
	///  This struct stores the hue, saturation, brightness, and alpha values internally as <see
	///  cref="byte" /> values from 0 to 255. The hue represents a fraction of the 360 degrees of
	///  color space available. The saturation is the color intensity, where 0 represents gray scale
	///  and 255 is the most colored. For the brightness, 0 represents black and 255 represents
	///  white.
	/// </remarks>
	[Serializable]
	public struct HSBColor
	{
		...
		/// <summary>
		///  Constructor to load an <see cref="HSBColor" /> struct from hue, saturation, brightness,
		///  and alpha values
		/// </summary>
		/// <param name="h">The color hue value, ranging from 0 to 255</param>
		/// <param name="s">
		...
		/// <summary>
		///  Constructor to load an <see cref="HSBColor" /> struct from a system <see cref="Color"
		///  /> struct.
		/// </summary>
		/// <param name="color">
		...
		/// </summary>
		/// <remarks>
		///  This method is based on code from http://www.cs.rit.edu/~ncs/color/ by Eugene
		///  Vishnevsky.
		/// </remarks>
		...
		/// <summary>
		///  Implicit conversion operator to convert directly from an <see cref="HSBColor" /> to a
		///  <see cref="Color" /> struct.
		/// </summary>
		/// <param name="hsbColor">The <see cref="HSBColor" /> struct to be converted</param>
		/// <returns>
		///  An equivalent <see cref="Color" /> struct that can be used in the GDI+ graphics library
		/// </returns>
		...
		public static Color ToRGB(HSBColor hsbColor)
		{
			...
			// Determine which sector of the color wheel contains this hue hsbColor.H ranges from 0
			// to 255, and there are 6 sectors, so 42.5 per sector
