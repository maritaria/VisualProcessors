...
namespace ZedGraph
{
	...
	public class Link : ISerializable, ICloneable
	{
		...
		///  associated with the <see cref="Link" />. ZedGraph does not use this value for any
		///  purpose.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		///  Gets a value that indicates if this <see cref="Link" /> is enabled (see <see
		///  cref="IsEnabled" />), and that either the <see cref="Url" /> or the <see cref="Title"
		///  /> is non-null.
		/// </summary>
		...
		/// <summary>
		///  Gets or sets a property that determines if this link is active. True to have a
		///  clickable link, false to ignore the link.
		/// </summary>
		...
		/// </summary>
		/// <remarks>
		///  This value should be set to a valid target associated with the "Target" property of an
		///  html hyperlink. Typically, this would be "_blank" to open a new browser window, or
		///  "_self" to open in the current browser.
		/// </remarks>
		...
		/// </summary>
		/// <remarks>
		///  For web controls, this title will be shown as a tooltip when the mouse hovers over the
		///  area of the object that owns this link. Set the value to <see cref="String.Empty" /> to
		///  have no title.
		/// </remarks>
		public string Title
		{
		...
		/// </summary>
		/// <remarks>
		///  Set this value to <see cref="String.Empty" /> if you don't want to have a hyperlink
		///  associated with the object to which this link belongs.
		/// </remarks>
		public string Url
		{
			get { return _url; }
		...
		/// <summary>
		///  Create a URL for a <see cref="CurveItem" /> that includes the index of the point that
		///  was selected.
		/// </summary>
		/// <remarks>
		///  An "index" parameter is added to the <see cref="Url" /> property for this link to
		///  indicate which point was selected. Further, if the X or Y axes that correspond to this
		///  <see cref="CurveItem" /> are of <see cref="AxisType.Text" />, then an additional
		///  parameter will be added containing the text value that corresponds to the <paramref
		///  name="index" /> of the selected point. The <see cref="XAxis" /> text parameter will be
		///  labeled "xtext", and the <see cref="YAxis" /> text parameter will be labeled "ytext".
		/// </remarks>
