...
namespace ZedGraph
{
	partial class ZedGraphControl
	{
		...
		// <summary>
		//  Public enumeration that specifies the type of object present at the Context Menu's mouse
		//  location
		// </summary>
		...
		///  boolean value that determines whether or not a prompt will be displayed. true to show a
		///  message of "Image Copied to ClipBoard".
		/// </param>
		public void Copy(bool isShowMessage)
		{
			if (_masterPane != null)
			{
				...
				// Threaded copy mode to avoid crash with MTA Contributed by Dave Moor
		...
		/// </summary>
		/// <remarks>
		///  This version is similar to the regular <see cref="Copy" /> method, except that it will
		///  place an Emf image (vector) on the ClipBoard instead of the regular bitmap.
		/// </remarks>
		/// <param name="isShowMessage">
		///  boolean value that determines whether or not a prompt will be displayed. true to show a
		///  message of "Image Copied to ClipBoard".
		...
		///  scales to full auto mode. The <see cref="ZoomOutAll" /> method sets the scales to their
		///  initial setting prior to any user actions (which may or may not be full auto mode).
		/// </remarks>
		...
		/// <summary>
		///  Handler for the "Save Image As" context menu item. Copies the current image to the
		///  selected file in either the Emf (vector), or a variety of Bitmap formats.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		///  Copies the current image to the selected file in Emf (vector), or a variety of Bitmap
		///  formats.
		/// </summary>
		/// <param name="DefaultFileName">
		///  Accepts a default file name for the file dialog (if "" or null, default is not used)
		/// </param>
		/// <returns>The file name saved, or "" if cancelled.</returns>
		/// <remarks>
		///  Note that <see cref="SaveAsBitmap" /> and <see cref="SaveAsEmf" /> methods are provided
		///  which allow for Bitmap-only or Emf-only handling of the "Save As" context menu item.
		/// </remarks>
		...
		/// </summary>
		/// <remarks>
		///  Note that this handler saves as a bitmap only. The default handler is <see
		///  cref="SaveAs()" />, which allows for Bitmap or EMF formats
		/// </remarks>
		...
		/// <summary>
		///  Handler for the "Save Image As" context menu item. Copies the current image to the
		///  selected Emf format file.
		/// </summary>
		/// <remarks>
		///  Note that this handler saves as an Emf format only. The default handler is <see
		///  cref="SaveAs()" />, which allows for Bitmap or EMF formats.
		/// </remarks>
		...
		/// <summary>
		///  Handler for the "UnZoom/UnPan" context menu item. Restores the scale ranges to the
		///  values before the last zoom, pan, or scroll operation.
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		///  Handler for the "Undo All Zoom/Pan" context menu item. Restores the scale ranges to the
		///  values before all zoom and pan operations
		/// </summary>
		/// <remarks>
		///  This method differs from the <see cref="RestoreScale" /> method in that it sets the
		///  scales to their initial setting prior to any user actions. The <see cref="RestoreScale"
		///  /> method sets the scales to full auto mode (regardless of what the initial setting may
		///  have been).
		/// </remarks>
		/// <param name="primaryPane">
		...
		/// <summary>
		///  Save the current Graph to the specified filename in EMF (vector) format. See <see
		///  cref="SaveAsEmf()" /> for public access.
		/// </summary>
		/// <remarks>
		///  Note that this handler saves as an Emf format only. The default handler is <see
		///  cref="SaveAs()" />, which allows for Bitmap or EMF formats.
		...
		/// <summary>
		///  Handler for the "Show Values" context menu item. Toggles the <see
		///  cref="IsShowPointValues" /> property, which activates the point value tooltips.
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e">     </param>
		...
		/// <summary>
		///  Handler for the "UnZoom/UnPan" context menu item. Restores the scale ranges to the
		///  values before the last zoom or pan operation.
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e">     </param>
		...
		private void contextMenuStrip1_Opening(object sender, CancelEventArgs e)
		{
			...
			if (_masterPane != null && menuStrip != null)
			{
				...
				if (_isShowContextMenu)
				{
					...
					// if e.Cancel is set to false, the context menu does not display it is
					// initially set to false because the context menu has no items
					e.Cancel = false;
