...
{
	/// <summary>
	///  A class representing a region on the GasGuage chart <see cref="GasGaugeRegion" />s.
	/// </summary>
	...
	public class GasGaugeRegion : CurveItem, ICloneable, ISerializable
	{
		...
		///  of the border around this <see cref="GasGaugeRegion" />. Use the public property <see
		...
		///  cref="GasGaugeRegion" />. Use the public property <see cref="Fill" /> to access this
		///  value.
		/// </summary>
		private Fill _fill;
		...
		/// <summary>
		///  Private field to hold the GraphicsPath of this <see cref="GasGaugeRegion" /> to be used
		///  for 'hit testing'.
		/// </summary>
		private GraphicsPath _slicePath;

		/// <summary>
		///  Internally calculated; Start angle of this pie that defines this <see
		///  cref="GasGaugeRegion" />
		/// </summary>
		private float _startAngle;

		/// <summary>
		///  Internally calculated; Sweep angle of this pie that defines this <see
		///  cref="GasGaugeRegion" />
		/// </summary>
		...
		/// <summary>
		///  Do all rendering associated with this <see cref="GasGaugeRegion" /> item to the
