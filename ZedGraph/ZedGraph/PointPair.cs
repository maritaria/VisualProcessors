...
namespace ZedGraph
{
	...
	public class PointPair : PointPairBase, ISerializable, ICloneable
	{
		...
		///  associated with the <see cref="PointPair" />. ZedGraph never modifies this value, but
		///  if it is a <see cref="String" /> type, it may be displayed in a <see
		///  cref="System.Windows.Forms.ToolTip" /> within the <see cref="ZedGraphControl" />
		///  object.
		/// </summary>
		/// <remarks>
		///  Note that, if you are going to Serialize ZedGraph data, then any type that you store in
		///  <see cref="Tag" /> must be a serializable type (or it will cause an exception).
		/// </remarks>
		public object Tag;

		/// <summary>
		///  This PointPair's Z coordinate. Also used for the lower value (dependent axis) for <see
		///  cref="HiLowBarItem" /> and <see cref="ErrorBarItem" /> charts.
		/// </summary>
		public double Z;
		...
		/// <summary>
		///  Creates a point pair with the specified X, Y, base value, and string label (<see
		///  cref="Tag" />).
		/// </summary>
		/// <param name="x">    This pair's x coordinate.</param>
		/// <param name="y">    This pair's y coordinate.</param>
		...
		/// </summary>
		/// <param name="pt">
		///  The <see cref="PointF" /> struct from which to get the new <see cref="PointPair" />
		///  values.
		/// </param>
		...
		/// <summary>
		///  The ColorValue property is just an alias for the <see cref="PointPair.Z" /> property.
		/// </summary>
		/// <remarks>
		///  For other types, such as the <see cref="StockPt" />, the <see cref="StockPt" /> can be
		///  mapped to a unique value. This is used with the <see
		///  cref="FillType.GradientByColorValue" /> option.
		/// </remarks>
		...
		/// <summary>
		///  Readonly value that determines if either the X, Y, or Z coordinate in this PointPair is
		///  an invalid (not plotable) value. It is considered invalid if it is missing (equal to
		///  System.Double.Max), Infinity, or NaN.
		/// </summary>
		...
		/// <summary>
		///  The "low" value for this point (lower dependent-axis value). This is really just an
		///  alias for <see cref="PointPair.Z" />.
		/// </summary>
		...
		/// <summary>
		///  Compares points based on their y values. Is setup to be used in anascending order
		///  sort.<seealso cref="System.Collections.ArrayList.Sort()" />
		/// </summary>
		...
		/// <summary>
		///  Compares points based on their x values. Is setup to be used in anascending order
		///  sort.<seealso cref="System.Collections.ArrayList.Sort()" />
		/// </summary>
		...
		/// <summary>
		///  Compares points based on their x values. Is setup to be used in an ascending order
		///  sort. <seealso cref="System.Collections.ArrayList.Sort()" />
		/// </summary>
		...
		/// <summary>
		///  Compares points based on their y values. Is setup to be used in an ascending order
		///  sort. <seealso cref="System.Collections.ArrayList.Sort()" />
		/// </summary>
		...
		///  <see cref="System.Double.ToString()" />).
		/// </param>
		/// <returns>A string representation of the PointPair</returns>
		/// <param name="isShowZ">
		///  true to show the third "Z" or low dependent value coordinate
		...
		/// <summary>
		///  Format this PointPair value using different general format strings for the X, Y, and Z
		///  values.
		...
		///  cref="System.Double.ToString()" />).
		/// </param>
		/// <param name="formatY">
		///  A format string that will be used to format the Y double type value (see <see
		///  cref="System.Double.ToString()" />).
		/// </param>
		/// <param name="formatZ">
		///  A format string that will be used to format the Z double type value (see <see
		///  cref="System.Double.ToString()" />).
		/// </param>
		/// <returns>A string representation of the PointPair</returns>
