...
namespace ZedGraph
{
	...
	public class Label : ICloneable, ISerializable
	{
		...
		/// <summary>
		///  Constructor to build an <see cref="AxisLabel" /> from the text and the associated font
		///  properties.
		/// </summary>
		/// <param name="text">       
		...
		/// <summary>
		///  Constructor that builds a <see cref="Label" /> from a text <see cref="string" /> and a
		///  <see cref="FontSpec" /> instance.
		/// </summary>
		...
		/// <summary>
		///  A <see cref="ZedGraph.FontSpec" /> instance representing the font properties for the
		///  displayed text.
		/// </summary>
		...
		/// <summary>
		///  Gets or sets a boolean value that determines whether or not this label will be
		///  displayed.
		/// </summary>
