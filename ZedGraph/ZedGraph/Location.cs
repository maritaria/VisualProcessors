...
namespace ZedGraph
{
	...
	public class Location : ICloneable, ISerializable
	{
		...
		/// <summary>
		///  Private field to store the horizontal alignment property for this object. Use the
		///  public property <see cref="Location.AlignH" /> to access this value. The value of this
		///  field is a <see cref="AlignH" /> enum.
		/// </summary>
		private AlignH _alignH;

		/// <summary>
		///  Private field to store the vertical alignment property for this object. Use the public
		///  property <see cref="Location.AlignV" /> to access this value. The value of this field
		///  is a <see cref="AlignV" /> enum.
		/// </summary>
		private AlignV _alignV;

		/// <summary>
		///  Private field to store the coordinate system to be used for defining the object
		///  position. Use the public property <see cref="CoordinateFrame" /> to access this value.
		///  The coordinate system is defined with the <see cref="CoordType" /> enum.
		/// </summary>
		private CoordType _coordinateFrame;

		/// <summary>
		///  Private fields to store the X and Y coordinate positions for this object. Use the
		///  public properties <see cref="X" /> and <see cref="Y" /> to access these values. The
		///  coordinate type stored here is dependent upon the setting of <see
		///  cref="CoordinateFrame" />.
		/// </summary>
		private double _x,
							_y,
							_width,
		...
		/// <summary>
		///  A horizontal alignment parameter for this object specified using the <see cref="AlignH"
		///  /> enum type.
		/// </summary>
		...
		/// <summary>
		///  A vertical alignment parameter for this object specified using the <see cref="AlignV"
		///  /> enum type.
		/// </summary>
		...
		/// </summary>
		/// <value>The coordinate system is defined with the <see cref="CoordType" /> enum</value>
		...
		/// </summary>
		/// <remarks>
		///  The units of this position are specified by the <see cref="CoordinateFrame" />
		///  property.
		/// </remarks>
		...
		/// <summary>
		///  The <see cref="RectangleF" /> for this object as defined by the <see cref="X" />, <see
		///  cref="Y" />, <see cref="Width" />, and <see cref="Height" /> properties.
		/// </summary>
		/// <remarks>
		///  Note that this method reduces the precision of the location coordinates from double
		///  precision to single precision. In some cases, such as <see cref="AxisType.Date" />, it
		...
		/// <remarks>
		///  The units of this position are specified by the <see cref="CoordinateFrame" />
		///  property. The object will be aligned to this position based on the <see cref="AlignH"
		///  /> property.
		/// </remarks>
		public double X
		{
		...
		///  The units of this position are specified by the <see cref="CoordinateFrame" />
		///  property. The object will be aligned to this position based on the <see cref="AlignH"
		///  /> property. This position is only used for objects such as <see cref="ArrowObj" />,
		///  where it makes sense to have a second coordinate. Note that the X2 position is stored
		...
		/// <remarks>
		///  The units of this position are specified by the <see cref="CoordinateFrame" />
		///  property. The object will be aligned to this position based on the <see cref="AlignV"
		///  /> property.
		/// </remarks>
		public double Y
		{
		...
		///  property. The object will be aligned to this position based on the <see cref="AlignV"
		///  /> property. This position is only used for objects such as <see cref="ArrowObj" />,
		///  where it makes sense to have a second coordinate. Note that the Y2 position is stored
		...
		/// <summary>
		///  Constructor for the <see cref="Location" /> class that specifies the x, y position and
		///  the <see cref="CoordType" />.
		/// </summary>
		/// <remarks>The (x,y) position corresponds to the top-left corner;</remarks>
		/// <param name="x">        
		...
		///  The <see cref="CoordType" /> enum that specifies the units for <see paramref="x" /> and
		///  <see paramref="y" />
		/// </param>
		...
		/// </param>
		/// <param name="alignH">   
		///  The <see cref="ZedGraph.AlignH" /> enum that specifies the horizontal alignment of the
		///  object with respect to the (x,y) location
		/// </param>
		/// <param name="alignV">   
		///  The <see cref="ZedGraph.AlignV" /> enum that specifies the vertical alignment of the
		///  object with respect to the (x,y) location
		/// </param>
		...
		///  the ending position (typically used for <see cref="ArrowObj" />'s).
		/// </remarks>
		/// <param name="x">        
		///  The x position, specified in units of <see paramref="coordType" />.
		/// </param>
		...
		/// <summary>
		///  Transform a data point from the specified coordinate type (<see cref="CoordType" />) to
		///  display device coordinates (pixels).
		/// </summary>
		/// <remarks>
		///  If <see paramref="pane" /> is not of type <see cref="GraphPane" />, then only the <see
		///  cref="CoordType.PaneFraction" /> transformation is available.
		/// </remarks>
		/// <param name="pane"> 
		///  A reference to the <see cref="PaneBase" /> object that contains the <see cref="Axis" />
		///  classes which will be used for the transform.
		/// </param>
		/// <param name="x">    The x coordinate that defines the point in user space.</param>
		/// <param name="y">    The y coordinate that defines the point in user space.</param>
		/// <param name="coord">
		///  A <see cref="CoordType" /> type that defines the coordinate system in which the X,Y
		///  pair is defined.
		/// </param>
		/// <returns>
		...
		/// <summary>
		///  Transform this <see cref="Location" /> object to display device coordinates using the
		///  properties of the specified <see cref="GraphPane" />.
		/// </summary>
		/// <param name="pane">
		///  A reference to the <see cref="PaneBase" /> object that contains the <see cref="Axis" />
		///  classes which will be used for the transform.
		...
		/// <summary>
		///  The <see cref="PointF" /> for this object as defined by the <see cref="X2" /> and <see
		///  cref="Y2" /> properties.
		/// </summary>
		/// <remarks>
		///  This method transforms the location to output device pixel units. The <see
		///  cref="AlignH" /> and <see cref="AlignV" /> properties are ignored for this
		...
		/// <summary>
		///  Transform the <see cref="RectangleF" /> for this object as defined by the <see cref="X"
		///  />, <see cref="Y" />, <see cref="Width" />, and <see cref="Height" /> properties.
		/// </summary>
		/// <remarks>
		///  This method transforms the location to output device pixel units. The <see
		///  cref="AlignH" /> and <see cref="AlignV" /> properties are honored in this
		///  transformation.
		/// </remarks>
		...
		/// <summary>
		///  Transform this <see cref="Location" /> from the coordinate system as specified by <see
		///  cref="CoordinateFrame" /> to the device coordinates of the specified <see
		///  cref="PaneBase" /> object.
		/// </summary>
		/// <remarks>
		///  The returned <see cref="PointF" /> struct represents the top-left corner of the object
		///  that honors the <see cref="Location" /> properties. The <see cref="AlignH" /> and <see
		///  cref="AlignV" /> properties are honored in this transformation.
		/// </remarks>
		/// <param name="pane">  
		///  A reference to the <see cref="PaneBase" /> object that contains the <see cref="Axis" />
		///  classes which will be used for the transform.
		...
		/// <summary>
		///  The <see cref="PointF" /> for this object as defined by the <see cref="X" /> and <see
		///  cref="Y" /> properties.
		/// </summary>
		/// <remarks>
		///  This method transforms the location to output device pixel units. The <see
