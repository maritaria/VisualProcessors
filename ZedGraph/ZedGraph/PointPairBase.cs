...
namespace ZedGraph
{
	...
	public class PointPairBase : ISerializable
	{
		...
		/// <summary>
		///  The default format to be used for displaying point values via the <see
		///  cref="ToString()" /> method.
		/// </summary>
		...
		/// <summary>
		///  Readonly value that determines if either the X or the Y coordinate in this PointPair is
		...
		/// </summary>
		/// <remarks>
		///  The value is considered invalid if it is <see cref="PointPairBase.Missing" />, <see
		///  cref="Double.PositiveInfinity" />, <see cref="Double.NegativeInfinity" /> or <see
		///  cref="Double.NaN" />.
		/// </remarks>
