...
namespace ZedGraph
{
	...
	public interface IPointListEdit : IPointList
	{
		...
		/// <summary>
		///  Appends a point to the end of the list. The data are passed in as a <see
		///  cref="PointPair" /> object.
		/// </summary>
		/// <param name="point">
		...
		/// <summary>
		///  Appends a point to the end of the list. The data are passed in as two <see
		///  cref="Double" /> types.
		/// </summary>
		/// <param name="x">
		...
		/// <summary>
		///  Clears all data points from the list. After calling this method, <see
		///  cref="IPointList.Count" /> will be zero.
		/// </summary>
		void Clear();
