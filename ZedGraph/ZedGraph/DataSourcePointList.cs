...
namespace ZedGraph
{
	...
	public class DataSourcePointList : IPointList
	{
		...
		///  property to a reference to your database, table or list object. The <see
		///  cref="System.Windows.Forms.BindingSource.DataMember" /> property would be set to the
		///  name of the datatable within the <see
		///  cref="System.Windows.Forms.BindingSource.DataSource" />, if applicable.
		/// </remarks>
		...
		/// </summary>
		/// <remarks>
		///  This property is just an alias for <see
		///  cref="System.Windows.Forms.BindingSource.DataSource" />.
		/// </remarks>
		...
		/// <summary>
		///  The <see cref="string" /> name of the property or column from which to obtain the tag
		///  values for the chart.
		/// </summary>
		/// <remarks>
		///  Set this to null leave the tag values set to null. If this references string data, then
		///  the tags may be used as tooltips using the <see
		///  cref="ZedGraphControl.IsShowPointValues" /> option.
		/// </remarks>
		...
		/// <summary>
		///  The <see cref="string" /> name of the property or column from which to obtain the X
		///  data values for the chart.
		/// </summary>
		/// <remarks>
		///  Set this to null leave the X data values set to <see cref="PointPairBase.Missing" />
		/// </remarks>
		...
		/// <summary>
		///  The <see cref="string" /> name of the property or column from which to obtain the Y
		///  data values for the chart.
		/// </summary>
		/// <remarks>
		///  Set this to null leave the Y data values set to <see cref="PointPairBase.Missing" />
		/// </remarks>
		...
		/// <summary>
		///  The <see cref="string" /> name of the property or column from which to obtain the Z
		///  data values for the chart.
		/// </summary>
		/// <remarks>
		///  Set this to null leave the Z data values set to <see cref="PointPairBase.Missing" />
		/// </remarks>
		...
		/// <summary>
		///  Constructor to initialize the DataSourcePointList from an existing <see
		///  cref="DataSourcePointList" />
		/// </summary>
		...
		/// <summary>
		///  Extract a double value from the specified table row or data object with the specified
		///  column name.
		/// </summary>
		...
		/// </param>
		/// <param name="index">     The zero-based index of the point to be extracted.</param>
		private double GetDouble(object row, string dataMember, int index)
		{
			...
			// if ( val == null ) throw new System.Exception( "Can't find DataMember '" + dataMember
			// + "' in DataSource" );
		...
		/// <summary>
		///  Extract an object from the specified table row or data object with the specified column
		///  name.
		/// </summary>
