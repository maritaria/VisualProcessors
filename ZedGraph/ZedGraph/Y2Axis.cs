...
namespace ZedGraph
{
	...
	public class Y2Axis : Axis, ICloneable, ISerializable
	{
		...
		/// <summary>
		///  A simple subclass of the <see cref="Default" /> class that defines the default property
		///  values for the <see cref="Y2Axis" /> class.
		/// </summary>
		public new struct Default
		{
			// <summary>
			//  The default display mode for the <see cref="Y2Axis" /> (<see cref="Axis.IsVisible"
			...
			/// <summary>
			///  Determines if a line will be drawn at the zero value for the <see cref="Y2Axis" />,
			///  that is, a line that divides the negative values from positive values. <seealso
			///  cref="MajorGrid.IsZeroLine" />.
			/// </summary>
		...
		/// <summary>
		///  Default constructor that sets all <see cref="Y2Axis" /> properties to default values as
		...
		/// <summary>
		///  Default constructor that sets all <see cref="Y2Axis" /> properties to default values as
		///  defined in the <see cref="Default" /> class, except for the axis title
		/// </summary>
		...
		/// </summary>
		/// <remarks>
		///  The cross axis is the axis which determines the of this Axis when the <see
		///  cref="Axis.Cross">Axis.Cross</see> property is used. The cross axis for any <see
		///  cref="XAxis" /> or <see cref="X2Axis" /> is always the primary <see cref="YAxis" />,
		///  and the cross axis for any <see cref="YAxis" /> or <see cref="Y2Axis" /> is always the
		///  primary <see cref="XAxis" />.
		/// </remarks>
		/// <param name="pane">
		...
		{
			// Move the origin to the BottomRight of the ChartRect, which is the left side of the Y2
			// axis (facing from the label side)
		...
		/// </summary>
		/// <remarks>
		///  The primary axes are the <see cref="XAxis" /> (always), the first <see cref="YAxis" />
		///  in the <see cref="GraphPane.YAxisList" /> (<see cref="CurveItem.YAxisIndex" /> = 0),
		///  and the first <see cref="Y2Axis" /> in the <see cref="GraphPane.Y2AxisList" /> (<see
		///  cref="CurveItem.YAxisIndex" /> = 0). Note that <see cref="GraphPane.YAxis" /> and <see
		///  cref="GraphPane.Y2Axis" /> always reference the primary axes.
		/// </remarks>
		/// <param name="pane">
		///  A reference to the <see cref="GraphPane" /> object that is the parent or owner of this
		///  object.
		...
		*/
		...
		// override internal float GetMinPix( GraphPane pane ) { return pane.Chart._rect.Top; }
