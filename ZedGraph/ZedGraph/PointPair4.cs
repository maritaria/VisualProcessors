...
namespace ZedGraph
{
	...
	public class PointPair4 : PointPair, ISerializable
	{
		...
		/// <summary>
		///  Creates a point pair with the specified X, Y, base value, and label (<see
		///  cref="PointPair.Tag" />).
		/// </summary>
		/// <param name="x">    This pair's x coordinate.</param>
		/// <param name="y">    This pair's y coordinate.</param>
		...
		/// <summary>
		///  Readonly value that determines if either the X, Y, Z, or T coordinate in this
		///  PointPair4 is an invalid (not plotable) value. It is considered invalid if it is
		...
		/// </param>
		/// <param name="formatT">
		///  A format string that will be used to format the T double type value (see <see
		///  cref="System.Double.ToString()" />).
		/// </param>
		/// <returns>A string representation of the PointPair</returns>
